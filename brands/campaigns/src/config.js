...
(function() {
    ...
    const config = {
        API_BASE_URL_MJ: "https://api.webflow.com/v2/collections",
        WORKER_BASE_URL_MJ: "https://meine-kampagnen.oliver-258.workers.dev/", // Wird von apiService verwendet
        JOB_COLLECTION_ID_MJ: "6448faf9c5a8a17455c05525",
        USER_COLLECTION_ID_MJ: "6448faf9c5a8a15f6cc05526",
        SKELETON_JOBS_COUNT_MJ: 3,
        API_CALL_DELAY_MS: 5,
        MAPPINGS: {
            followerRanges: {
    ...
    window.WEBFLOW_API.config = config;
