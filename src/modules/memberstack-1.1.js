(function() {
    ...
    class MemberstackService {
        ...
        getMembershipDetails(member) {
            if (!member || !member.data) {
                ...
                return {
                    limit: CONFIG.FREE_MEMBER_LIMIT || 3, // Fallback-Wert
                    status: 'Free'
                };
            }
            ...
            const freeLimit = CONFIG.FREE_MEMBER_LIMIT || 3;
            const paidLimit = CONFIG.PAID_MEMBER_LIMIT || 10;
    ...
    window.WEBFLOW_API.MEMBERSTACK = new MemberstackService();
})();
