// src/logic/matchScoring.js
// This module is responsible for calculating the match score between an applicant and a job.

/**
 * Calculates the match score of an applicant for a job based on predefined criteria.
 * @param {object} applicantFieldData - The fieldData object of the applicant.
 * @param {object} jobFieldData - The fieldData object of the job.
 * @param {object} allMappings - The MAPPINGS object from config.js.
 * @returns {object} An object containing the score, details, rawScore, and maxScore.
 * Returns { score: 0, details: {}, rawScore: 0, maxScore: 0 } if data is insufficient.
 */
export function calculateMatchScore(applicantFieldData, jobFieldData, allMappings) {
    ...
    const scoringCriteria = [
        {
            name: "Kategorie",
            jobField: "industrie-kategorie",
            applicantField: "creator-main-categorie",
            points: 20,
            type: "exactStringMatch"
        },
        {
            name: "Creator Typ",
            jobField: "job-required-creator-types",
            applicantField: "creator-type",
            points: 25,
            type: "idInJobArray",
        ...
        },
        {
            ...
            applicantField: "bundesland-option",
            points: 15,
            type: "idInJobArray",
        ...
        },
        {
            ...
            applicantField: "creator-follower",
            points: 15,
            type: "exactIdMatch"
        },
        {
        ...
        },
        {
            ...
            applicantField: "sprachen",
            points: 15,
            type: "anyIdOverlapInArrays",
