 ...
 */
var InfluencerContract = (function() {
    // Private Variablen
    var formData = {};
    var maxSteps = 9;
    ...
    function init() {
        ...
        updateProgress(Navigation.getCurrentStep());
    }
    ...
    function collectFormData() {
        ...
        var timer = Debug.startPerformanceTimer('collectFormData');
        ...
        try {
            ...
            // Zeitplan
            formData.schedule = {
                briefingDate: PDFGenerator.formatDate(getFieldValue('briefing-date', '')),
                scriptDate: PDFGenerator.formatDate(getFieldValue('script-date', '')),
                scriptTime: getFieldValue('script-time', '12:00'),
                productionStart: PDFGenerator.formatDate(getFieldValue('production-start', '')),
                productionEnd: PDFGenerator.formatDate(getFieldValue('production-end', '')),
                productionLocation: getFieldValue('production-location', '[Adresse]'),
                deliveryDate: PDFGenerator.formatDate(getFieldValue('delivery-date', '')),
                deliveryTime: getFieldValue('delivery-time', '12:00'),
                publicationDate: PDFGenerator.formatDate(getFieldValue('publication-date', ''))
            };
    ...
    function generatePDF() {
        ...
        var timer = Debug.startPerformanceTimer('generatePDF');
        ...
        try {
            ...
            // Erfolgsanzeige
            UIController.showSuccessAnimation();
    ...
    function addContractContent(doc) {
        ...
        // Anstatt den kompletten Vertragstext hier einzufügen,
        // verwenden wir eine vereinfachte Version zur Demonstration
        ...
        if (isClientContract) {
            ...
            doc.setFont("helvetica", "bold");
            doc.text(formData.client.street, 30 + doc.getTextWidth("Straße: "), y);
...
// Bei der ContractTypeFactory registrieren
ContractGenerator.registerContractType('influencer', InfluencerContract);
